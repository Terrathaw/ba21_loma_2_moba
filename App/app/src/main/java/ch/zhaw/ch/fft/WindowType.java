...
public enum WindowType {
    RECTANGULAR("Rectangular", 0), TRIANGULAR("Triangular", 1), HAMMING("Hamming", 2), HANN("Hann", 3), BLACKMAN("Blackman", 4), NUTTAL("Nuttal", 5), WELCH("Welch", 6), BARTLETT("Bartlett", 7), BARTLETT_HANN("Bartlett-Hann", 8), BLACKMAN_HARRIS("Blackman-Harris", 9), BLACKMAN_NUTTAL("Blackman-Nuttal", 10);
