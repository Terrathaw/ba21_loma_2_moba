...
public class Window {
    ...
    private int cacheWindowSize;
    private float[] cacheWindow;
    ...
    public float[] getWindow(int size) {
        if (size == cacheWindowSize) return cacheWindow;
        cacheWindowSize = size;
        switch (windowType) {
            case TRIANGULAR:
                cacheWindow = getTriangularWindow(size);
                break;
            case HANN:
                cacheWindow = getHannWindow(size);
                break;
            case HAMMING:
                cacheWindow = getHammingWindow(size);
                break;
            case BLACKMAN:
                cacheWindow = getBlackmanWindow(size);
                break;
            case NUTTAL:
                cacheWindow = getNuttalWindow(size);
                break;
            case WELCH:
                cacheWindow = getWelchWindow(size);
                break;
            case BARTLETT:
                cacheWindow = getBartlettWindow(size);
                break;
            case BARTLETT_HANN:
                cacheWindow = getBartlettHannWindow(size);
                break;
            case BLACKMAN_HARRIS:
                cacheWindow = getBlackmanHarrisWindow(size);
                break;
            case BLACKMAN_NUTTAL:
                cacheWindow = getBlackmanNuttalWindow(size);
                break;
            default:
                cacheWindow = getRectangularWindow(size);
                break;
        }
        return cacheWindow;
    }
