...
public class RubberBandStretcher
{
    ...
    public static final int OptionTransientsCrisp      = 0x00000000;//full range
    public static final int OptionTransientsMixed      = 0x00000100;//band limit
    public static final int OptionTransientsSmooth     = 0x00000200;//no transient detection
